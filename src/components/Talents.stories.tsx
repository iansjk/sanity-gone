...
Default.args = {
  analyses: [
    ...
    `,
    `
      <p>Her second talent, <b>Brotherhood</b>, is a very powerful talent when it takes effect.</p>
      <TalentInfo />
      <p>It’s pretty simple, it reduces all incoming damage from Sarkaz enemies by 30%, it doesn’t need much explanation. It’s very effective when fighting against Sarkaz enemies (which are thankfully not too uncommon), doesn’t matter outside of that.</p>
    `,
  ],
  talentObjects: [
    {
