...
Default.args = {
  synergies: [
    ...
    },
    {
      ...
      analysis: `
          <p>The best buffer to use with Mudrock; as he can provide her defensive and offensive buffs depending on what you want. You can use S2 to increase her DEF and Max HP (which her self-heals scale off of) for better tanking and sustain, or S3 to increase her ATK and ASPD for better damage output. She has a base DEF high enough to hit the minimum damage threshold tanking his shots, and she can be buffed during S3 invulnerability phase and still get the buffs without losing anything. Aak does no harm at all for once, unbelievable right?</p>
      `,
    },
    {
      name: "Angelina",
    ...
    },
    {
      ...
      quality: SynergyQuality["Good Synergy"],
      analysis: `
          <p>Another rather simple talent synergy; Ch’en’s talent helps passively charge skills with Offensive and Defensive recoveries. It’s nowhere as powerful as Blemishine’s talent, but it’s still helpful nonetheless if your objective is to help keep Mudrock spinning.</p>
      `,
    },
    {
      name: "Elysium",
